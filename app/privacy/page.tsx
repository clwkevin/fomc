...
import { ChevronRight, ExternalLink, AlertTriangle, Info, Shield } from "lucide-react"
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <section className="py-6 sm:py-8">
              ...
              <div className="bg-yellow-50 dark:bg-yellow-950/20 p-5 rounded-xl border border-yellow-200/50 dark:border-yellow-800/30 flex items-start gap-3">
                ...
                <p className="text-yellow-700 dark:text-yellow-300 leading-relaxed text-base sm:text-lg">
                  Please note that blockchain transactions are public and immutable. Any information stored on the blockchain cannot be deleted or modified. This includes transaction data, wallet addresses, and other on-chain information.
                </p>
              </div>
            </section>
