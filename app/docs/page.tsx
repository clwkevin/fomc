...
export default function DocsPage() {
  ...
  return (
    <div className="min-h-screen hero-gradient">
      <div className="container px-4 sm:px-6 lg:px-8 max-w-5xl py-24 sm:py-28 lg:py-32 mx-auto">
        {/* Header Section */}
        ...
        {/* Quick Navigation */}
        <div className="mb-12">
          <Card className="p-6 card-hover border border-border/50 bg-card/50 backdrop-blur-sm">
            <h3 className="text-lg sm:text-xl font-semibold mb-4 text-foreground">Quick Navigation</h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              {[
                ...
                <Link
                  key={index}
                  href={item.href}
                  className="flex items-center justify-center text-center p-3 rounded-lg border border-border/50 hover:border-primary/50 hover:bg-primary/10 transition-all duration-200 text-muted-foreground hover:text-foreground"
                >
        ...
        <div className="space-y-10 sm:space-y-12 lg:space-y-16">
          {/* Getting Started */}
          <Card id="getting-started" className="card-hover border-0 bg-card/50 backdrop-blur-sm shadow-xl overflow-hidden">
          ...
          {/* Features */}
          <Card id="features" className="card-hover border-0 bg-card/50 backdrop-blur-sm shadow-xl overflow-hidden">
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-start mb-6 sm:mb-8">
                <div className="bg-gradient-to-r from-primary to-accent text-primary-foreground w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-lg sm:text-xl font-bold mr-4 sm:mr-6 shadow-lg flex-shrink-0">
                  2
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {[
                  ...
                  <div key={index} className="bg-gradient-to-br from-background to-muted/30 p-5 rounded-xl border border-border/50 hover:border-primary/30 transition-all duration-200">
          ...
          {/* Contract Addresses */}
          <Card id="contracts" className="card-hover border-0 bg-card/50 backdrop-blur-sm shadow-xl overflow-hidden">
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-start mb-6 sm:mb-8">
                <div className="bg-gradient-to-r from-primary to-accent text-primary-foreground w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-lg sm:text-xl font-bold mr-4 sm:mr-6 shadow-lg flex-shrink-0">
                  3
          ...
          {/* How to Use */}
          <Card id="how-to-use" className="card-hover border-0 bg-card/50 backdrop-blur-sm shadow-xl overflow-hidden">
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-start mb-6 sm:mb-8">
                <div className="bg-gradient-to-r from-primary to-accent text-primary-foreground w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-lg sm:text-xl font-bold mr-4 sm:mr-6 shadow-lg flex-shrink-0">
                  4
              ...
              <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
                {[
                  ...
                  <div key={index} className="bg-gradient-to-br from-background to-muted/20 p-5 rounded-xl border border-border/50">
          ...
          {/* Security */}
          <Card id="security" className="card-hover border-0 bg-card/50 backdrop-blur-sm shadow-xl overflow-hidden">
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-start mb-6 sm:mb-8">
                <div className="bg-gradient-to-r from-primary to-accent text-primary-foreground w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-lg sm:text-xl font-bold mr-4 sm:mr-6 shadow-lg flex-shrink-0">
                  5
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
                <div className="space-y-4 sm:space-y-6">
                  <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20 p-5 rounded-xl border border-red-200/50 dark:border-red-800/30">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 p-5 rounded-xl border border-green-200/50 dark:border-green-800/30">
          ...
          {/* Support */}
          <Card id="support" className="card-hover border-0 bg-card/50 backdrop-blur-sm shadow-xl overflow-hidden">
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-start mb-6 sm:mb-8">
                <div className="bg-gradient-to-r from-primary to-accent text-primary-foreground w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-lg sm:text-xl font-bold mr-4 sm:mr-6 shadow-lg flex-shrink-0">
                  6
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                {[
                  ...
                  <div key={index} className="bg-gradient-to-br from-background to-muted/20 p-5 rounded-xl border border-border/50 hover:border-primary/30 transition-all duration-200 text-center">
                    ...
                    <Link href={support.href} className="inline-flex items-center text-primary hover:text-primary/80 text-xs sm:text-sm font-medium transition-colors">
                      {support.action} <ChevronRight className="h-3.5 w-3.5 ml-1" />
                    </Link>
                  </div>
                ))}
              </div>

              <div className="mt-8 p-5 bg-gradient-to-r from-primary/10 to-accent/10 rounded-xl border border-primary/20 text-center">
                ...
                <Link href="#" className="inline-flex items-center bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 sm:px-6 sm:py-2.5 rounded-lg font-medium transition-colors text-sm sm:text-base">
                  Start Live Chat
                </Link>
              </div>
            </div>
        ...
        <div className="mt-16 sm:mt-20 text-center">
          <div className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 sm:p-10 rounded-2xl border border-primary/20">
            ...
            <Link
              href="/"
              className="inline-flex items-center px-6 py-3 sm:px-8 sm:py-3.5 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-xl transition-colors shadow-lg hover:shadow-xl text-sm sm:text-base"
            >
              Launch AllSwap DEX <ChevronRight className="ml-2 h-5 w-5" />
            </Link>
          </div>
        </div>
      </div>
